  ...
  module EDAM
    module NoteStore
            ...
            class NoteVersionId
              ...
              ::Thrift::Struct.field_accessor self, :updateSequenceNum, :updated, :serviceUpdated
              FIELDS = {
                UPDATESEQUENCENUM => {:type => ::Thrift::Types::I32, :name => 'updateSequenceNum'},
                UPDATED => {:type => ::Thrift::Types::I64, :name => 'updated'},
                SERVICEUPDATED => {:type => ::Thrift::Types::I64, :name => 'serviceUpdated'}
              }
              ...
              def validate
                ...
                raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field serviceUpdated is unset!') unless @serviceUpdated
              end
