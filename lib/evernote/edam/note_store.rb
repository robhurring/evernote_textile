                ...
                module NoteStore
                  module NoteStore
                    ...
                    class ListNoteVersions_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :noteGuid
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        NOTEGUID => {:type => ::Thrift::Types::STRING, :name => 'noteGuid'}
                      }
                    ...
                    class GetNoteVersion_args
                      ...
                      ::Thrift::Struct.field_accessor self, :authenticationToken, :noteGuid, :updateSequenceNum, :withResourcesData, :withResourcesRecognition, :withResourcesAlternateData
                      FIELDS = {
                        AUTHENTICATIONTOKEN => {:type => ::Thrift::Types::STRING, :name => 'authenticationToken'},
                        NOTEGUID => {:type => ::Thrift::Types::STRING, :name => 'noteGuid'},
